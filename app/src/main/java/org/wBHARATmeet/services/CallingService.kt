package org.wBHARATmeet.services
...
import org.wBHARATmeet.activities.calling.AgoraConfig
import org.wBHARATmeet.activities.calling.CallingActivity
import org.wBHARATmeet.activities.calling.event.CallingStateEvent
import org.wBHARATmeet.activities.calling.event.CallingViewState
import org.wBHARATmeet.activities.calling.model.*
import org.wBHARATmeet.common.extensions.abandonAudioFocusCompat
import org.wBHARATmeet.common.extensions.requestAudioFocusCompat
...
import org.wBHARATmeet.utils.network.CallsManager
import org.wBHARATmeet.utils.network.FireManager
import io.agora.rtc.Constants
import io.agora.rtc.Constants.AUDIO_PROFILE_MUSIC_HIGH_QUALITY_STEREO
...
class CallingService : Service(), ProximitySensor.Delegate, AudioManager.OnAudioFocusChangeListener, DuringCallEventHandler {
    ...
    private fun joinChannel(channelName: String, uid: Int): Int {
        ...
        rtcEngine().setAudioProfile(AUDIO_PROFILE_MUSIC_HIGH_QUALITY_STEREO, AUDIO_SCENARIO_GAME_STREAMING);
