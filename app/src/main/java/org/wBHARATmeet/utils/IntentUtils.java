...
import org.wBHARATmeet.BuildConfig;
...
public class IntentUtils {
    ...
    public static Intent getSendEmailIntent(Context context) {
        String email = "meghanchittimalla@gmail.com";
    ...
    public static Intent getOpenTwitterIntent() {
        String twitterId = "https://twitter.com/gibberon?s=09";
    ...
    public static Intent getShareAppIntent(Context context) {
        ...
        String link = "https://play.google.com/store/apps/details?id=org.wBHARATmeet";//app link is auto generated by using package name
