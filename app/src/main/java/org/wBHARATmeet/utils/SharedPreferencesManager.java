...
import org.wBHARATmeet.model.constants.NetworkType;
...
public class SharedPreferencesManager {
    ...
    public static void saveTempBool(Boolean value) {
        mSharedPref.edit().putBoolean("saveTemp", value).apply();
    }
    ...
    public static boolean getSavedTempBool() { return mSharedPref.getBoolean("saveTemp", false); }
