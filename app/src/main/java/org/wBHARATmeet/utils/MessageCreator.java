...
import org.wBHARATmeet.model.realms.RealmLocation;
...
public class MessageCreator {
    ...
    private static Message createBlocked() {


        //messageId

        final Message message = new Message();
        message.setType(MessageType.USER_BLOCKED_MSG);
    ...
    public static class Builder {
        ...
        public Builder block(String string_block) {
            this.string_block = string_block;
            return this;
        }
