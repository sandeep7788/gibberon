...
import org.wBHARATmeet.model.realms.Broadcast;
import org.wBHARATmeet.model.realms.Chat;
import org.wBHARATmeet.model.realms.CurrentUserInfo;
import org.wBHARATmeet.model.realms.DeletedMessage;
import org.wBHARATmeet.model.realms.FireCall;
import org.wBHARATmeet.model.realms.Group;
import org.wBHARATmeet.model.realms.JobId;
import org.wBHARATmeet.model.realms.Message;
import org.wBHARATmeet.model.realms.PendingGroupJob;
import org.wBHARATmeet.model.realms.Status;
import org.wBHARATmeet.model.realms.StatusSeenBy;
import org.wBHARATmeet.model.realms.UnUpdatedStat;
import org.wBHARATmeet.model.realms.UnUpdatedVoiceMessageStat;
...
/*
    ...
    public void saveStatus(String userId, Status status) {
        ...
        if (SharedPreferencesManager.getSavedTempBool()) {
            Log.e("@@TAG", "saveStatus: 2"+SharedPreferencesManager.getSavedTempBool());
            SharedPreferencesManager.saveTempBool(false);

            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Log.e(">>TAG", "saveStatus: 4");
