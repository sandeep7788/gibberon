...
import org.wBHARATmeet.receivers.HandleReplyReceiver;
import org.wBHARATmeet.receivers.MarkAsReadReceiver;
...
import static org.wBHARATmeet.utils.IntentUtils.NOTIFICATION_ACTION_DECLINE;
import static org.wBHARATmeet.utils.MessageTypeHelper.getMessageContent;
...
//        start chatActivity with the clicked user
    ...
    private NotificationCompat.Builder createNotificationBuilder(
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), NOTIFICATION_CHANNEL_ID_MESSAGES)
                //set app icon
                .setSmallIcon(R.drawable.notifaction_logo)
