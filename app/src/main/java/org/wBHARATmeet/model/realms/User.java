...
public class User extends RealmObject implements Parcelable {
    ...
    public String getDisapperSec() {
        return disapperSec;
    }

    public void setDisapperSec(String disapperSec) {
        this.disapperSec = disapperSec;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.disapperSec);
        dest.writeByte(isDisappear ? (byte) 1 : (byte) 0);
