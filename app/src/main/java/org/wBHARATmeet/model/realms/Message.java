package org.wBHARATmeet.model.realms;
...
public class Message extends RealmObject implements Parcelable, Comparable {
    ...
    public String getAppearMaxTime() {
        return appearMaxTime;
    }

    public void setAppearMaxTime(String appearMaxTime) {
        this.appearMaxTime = appearMaxTime;
    }
    ...
    public Map<String, Object> toMap() {
        ...
        result.put(DBConstants.APPERMAXTIME, appearMaxTime);
    ...
    public Message getClonedMessage() {
        ...
        message.setAppearMaxTime(appearMaxTime);
        return message;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(appearMaxTime);
    ...
    protected Message(Parcel in) {
        ...
        this.appearMaxTime = in.readString();
