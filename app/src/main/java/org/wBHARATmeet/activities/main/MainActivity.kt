package org.wBHARATmeet.activities.main
...
import org.wBHARATmeet.activities.*
import org.wBHARATmeet.activities.settings.SettingsActivity
import org.wBHARATmeet.adapters.CustomViewPager
import org.wBHARATmeet.adapters.ViewPagerAdapter
import org.wBHARATmeet.common.ViewModelFactory
import org.wBHARATmeet.common.extensions.findFragmentByTagForViewPager
...
import org.wBHARATmeet.job.DailyBackupJob
import org.wBHARATmeet.job.SaveTokenJob
import org.wBHARATmeet.job.SetLastSeenJob
import org.wBHARATmeet.model.realms.User
import org.wBHARATmeet.services.FCMRegistrationService
import org.wBHARATmeet.services.InternetConnectedListener
import org.wBHARATmeet.services.NetworkService
import org.wBHARATmeet.utils.*
import org.wBHARATmeet.utils.network.FireManager
import org.wBHARATmeet.views.dialogs.IgnoreBatteryDialog

class MainActivity : BaseActivity(), FabRotationAnimation.RotateAnimationListener, FragmentCallback, StatusFragmentCallbacks {

    fun initializationPopUpMultipleButton() {

        var img_chat:ImageView=findViewById(R.id.img_chat)
        var menu_container:LinearLayout=findViewById(R.id.menu_container)
        var img_call:ImageView=findViewById(R.id.img_call)
        var img_new_group:ImageView=findViewById(R.id.img_new_group)


        img_chat.setOnClickListener { viewPager.setCurrentItem(0, true);  }
        img_call.setOnClickListener { viewPager.setCurrentItem(2, true);  }
        img_new_group.setOnClickListener { createGroupClicked()  }
//        img_status.setOnClickListener { viewPager.setCurrentItem(1, true);  }

    }
    fun onClickStatusProfile() {
...
//for status manage
        SharedPreferencesManager.saveTempBool(true)
     ////
    ...
    private fun init() {
        ...
        fab.bringToFront()
        initializationPopUpMultipleButton()
...
//            R.id.overflowMenu -> openOptionsMenu()
